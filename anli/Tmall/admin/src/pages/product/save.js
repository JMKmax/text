...
* @Last Modified time: 2019-05-03 19:59:03
*/
        	...
        	<div className="ProductSave">
        		<Layout>
                    ...
                    <Form {...formItemLayout}>
                        ...
                        <Form.Item label="商品描述">
                          <RichEditor 
                            url={UPLOAD_DETAIL_IMAGE}
                            getRichEditorValue={(values)=>{
                              handleDetail(values)
                            }}
                            detail={detail}
                          />
...
const mapDispatchToProps = (dispatch)=>{
    return {
        ...
        handleDetail:(values)=>{
          const action = actionCreator.getSetDetailAction(values)
          dispatch(action)
        },
